...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: Qwoyn.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: Qwoynd.pid)") + "\n";
...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizeqwoynamount=<n> " + _("Keep N Qwoyn anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Qwoyn is probably already running."), strDataDir));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Qwoyn version %s (%s)\n", FormatFullVersion(), CLIENT_DATE);
    ...
    LogPrintf("Anonymize Qwoyn Amount %d\n", nAnonymizeQwoynAmount);
